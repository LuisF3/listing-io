    ...
    <div id="signup" class="container text-center border rounded shadow-sm mt-16">
        <div class="row">
            <div class="col-12 col-md-6 bg-primary py-12">
                <img src="../assets/signup.svg" style="width: 92%; height: 92%;">
            </div>
            <div class="col-12 col-md-6 py-12">
                <h3 class="mb-4 mt-5" style="font-size: 2rem;">Informações pessoais</h3>
                <form class="px-16">
                    <div>
                        <input class="bg-gray-300 rounded-pill py-1 m-2 px-3 border-2 focus-purple placeholder-gray-700" type="email" placeholder="E-mail" v-model="email"/>
                        <input class="bg-gray-300 rounded-pill py-1 m-2 px-3 border-2 focus-purple placeholder-gray-700" type="text" placeholder="Nome" v-model="name"/>
